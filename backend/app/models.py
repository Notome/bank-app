from sqlalchemy import Integer, String, ForeignKey, Boolean, DateTime, Float, Enum as SAEnum
...
class AccountTable(Base):
    ...
    sent_transactions: Mapped[list["TransactionTable"]] = relationship(
        foreign_keys="TransactionTable.sender_account_id",
        back_populates="sender_account"
    )
    received_transactions: Mapped[list["TransactionTable"]] = relationship(
        foreign_keys="TransactionTable.receiver_account_id",
